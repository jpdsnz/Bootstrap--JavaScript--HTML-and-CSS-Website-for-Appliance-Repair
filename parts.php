...
<div class="container-fluid">
    <div class="row">
      <div class="col-lg-12 page-header text-center">
        <h2 class="MainHeading"> <span class="glyphicon glyphicon-wrench PurpleStar" aria-hidden="true"></span> &nbsp;Parts &nbsp; Supply :</h2>
      </div>
    </div>
  </div>
  <div class="container ">
    <div class="row">
      <div class="col-sm-12 text-center col-md-12 col-lg-6">
        <h3 class="SecondHeading">Appliance and HVAC Parts Available Now!</h3>
        <p>We make appliance and HVAC AC parts easy to find for the do-it-yourselfer! You can search using your appliance model number, appliance part number, or a description of the appliance part. We offer appliance repair help experience and are ready to assist you in anyway we can.</p>
      </div>
      <div class="col-sm-12 text-center col-md-12 col-lg-6">
        <h3 class="SecondHeading">Click the Phone Icon or Button Below!</h3>
        <p>Click on the phone icon to talk to us in person and find out what parts you are looking for. You can also click the "Find My Part" button to email us and you can then proceed to enter the necessary information to find your part. </p>
      </div>
    </div>
</div>
