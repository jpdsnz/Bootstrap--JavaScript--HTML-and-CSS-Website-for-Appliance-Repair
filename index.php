...
<!--Facebook SEO-->
 ...
 <meta property="og:url" content="https://tarrantcountyappliance.com/index">
  ...
  <div class="container-fluid" id="navbarContainer">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li class="active"><a href="https://www.appliance-repair-experts.com/" ><span class="glyphicon glyphicon-home" aria-hidden="true"></span> Home <span class="sr-only">(current)</span></a> </li>
...
<header>
  ...
  <div class="container-fluid CouponContainer"><a href="https://tarrantcountyappliance.setmore.com" title="Click here to schedule!" target="_blank"><img src="images/CouponV2.png" alt="Same Day Repair!" width="800" height="520" class="Coupon img-responsive" title="10 Percent Off!"></a>
        
		<h2 class="MainHeading">
			<!--<p>Proud&nbsp; member&nbsp; of&nbsp; <a href="https://www.checkmybadge.com/" title="Click here to go to CheckMyBadge.com!" target="_blank"><img class="Coupon img-responsive" src="/images/shield2.png" alt="" title="Click here to go to CheckMyBadge.com!" style="width:auto ;height:auto;"></a></p>-->
